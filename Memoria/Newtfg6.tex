...
Y ahora unos comentarios más personales, de mi experiencia a lo largo del desarrollo de este proyecto.
\begin{enumerate}
...
\item[5.] Ha sido interesante adentrarse en el mundo de la programación y tratamiento de señales a un nivel más allá del necesario para superar la carrera. De esta forma, he aprendido y ampliado mis conocimientos en el campo, y además lo he disfrutado.
\end{enumerate}
