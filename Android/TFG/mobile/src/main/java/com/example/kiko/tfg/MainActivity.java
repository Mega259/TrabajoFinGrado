            ...
            if(isOn){
                Thread writerThread = new Thread() {
                    ...
                    public void run() {
                        try {
                            String message = intent.getStringExtra("message");
                            break_data[0][0] = (float) Float.parseFloat(message.split(",")[0]);// ((message_break[0] + 3.036879)/7.213168); //
                            break_data[0][1] = (float) Float.parseFloat(message.split(",")[1]);// ((message_break[1] + 3.869599)/8.843972); //
                            break_data[0][2] = (float) Float.parseFloat(message.split(",")[2]);// ((message_break[2] - 4.779501)/6.318493); //
                            try {
                                ...
                                if (i < 8) {
                                    ...
                                    Log.e("PRUEBAS2", Integer.toString(results[0]));
                                    if(Math.abs(break_data[0][0]) > 65 || Math.abs(break_data[0][1]) > 65 || Math.abs(break_data[0][2]) > 65) {
                                        resultado[3] = resultado[3] + 2;
                                        Log.e("PRUEBAS3", Integer.toString(results[0]));

                                    }
                                    i++;
                                    Log.e("PRUEBAS4", Integer.toString(results[0]));
                                } else {
                                    Log.e("PRUEBAS5", Integer.toString(results[0]));
                                    i = 0;
                                    ...
                                    Log.e("PRUEBAS6", Integer.toString(results[0]));
                                    ...
                                    if (map.get(maxValue) == 1 && map.get(maxValue2) == 2 && (maxValue-maxValue2) < 0.5) {
