...
def tipifylist(list_to_tipify):
	"""
	Function that tipifies the list, every value minus the mean get divided by the standard deviation, so finally, all the data has mean 0 and stdesv 1
...
wkdir='/Users/kiko/Documents/MATLAB/TFG/New folder'
tf.train.write_graph(frozen_graph, wkdir, 'pruebas.pb', as_text=False)
