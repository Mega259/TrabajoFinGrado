...
alltraining, alltesting = random_split(alldata)
...
epoch=40
hist=model.fit(testing_var, testing_res, epochs=epoch, batch_size=8, validation_data=(training_var, training_res), shuffle=True)
